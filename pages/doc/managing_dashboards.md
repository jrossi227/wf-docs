...
<span class="wysiwyg-font-size-large wysiwyg-font-size-medium" style="font-size: 12pt;">[<img src="images/three+icons.PNG" alt="three icons.PNG" class="image-22 jive-image" width="34" height="81" />](three+icons.PNG)
...
You can apply dashboard variables to an existing dashboard. For information on dashboard variables, see <a href="https://community.wavefront.com/docs/DOC-1062" class="jive-link-wiki-small">Dashboard Variables</a>.
